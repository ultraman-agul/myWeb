...
// 2 字符串操作方法
concat(string2, string3[, ..., stringN)   		//拼接字符串，等效于+，+更常用
slice(startIndex, endIndex)    		//从start位置开始，截取到end位置，end取不到
substring(startIndex,endIndex) 	//从start位置开始，截取到end位置，end取不到
